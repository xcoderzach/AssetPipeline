...
ScriptPipeline.prototype.getPreScriptFiles = function() {
  return this.pre
} 

ScriptPipeline.prototype.getPostScriptFiles = function() {
  return this.post
} 
...
ScriptPipeline.prototype.getScriptTags = function(opts) {
  ...
  if(opts.pre) {
    files = this.getPreScriptFiles() 
  } else if(opts.post) {
    files = this.getPostScriptFiles() 
  } else {
    files = this.getPostScriptFiles() 
  }
