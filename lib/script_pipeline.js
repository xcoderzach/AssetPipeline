...
function ScriptPipeline(parent) {
  this.parent = parent
...
ScriptPipeline.prototype.routeToRoute = function(match, fromRoute, toRoute) {
...
ScriptPipeline.prototype.url = function(from) {
  this.urlRoute = new Route("GET", path.resolve(from))
  return this
}

ScriptPipeline.prototype.file = function(to) {
