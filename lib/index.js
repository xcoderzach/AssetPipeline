...
AssetPipe.prototype.fileFromUrl = function(url, next, callback) {
  ...
  if(url === "/js/concat.js") {
    var done = function(contents) {
      ...
      callback(null, finalCode, "text/javascript")
    }
    ...
    _(this.pipes).each(function(pipe) {
      ...
      if(typeof pipe.getScriptsContents === "function") {
        ...
        scripts += pipe.getScriptsContents(function(err, contents) {
          scripts += "\n" + contents
          if(--numDone === 0) {
            done(pre + "\n" + scripts + "\n" + post)
          }
        })
        post += pipe.getPostScriptsContents(function(err, contents) {
          post += "\n" + contents
          if(--numDone === 0) {
            done(pre + "\n" + scripts + "\n" + post)
          }
...
AssetPipe.prototype.scriptTags = function() {
  //uncomment to concat all teh scrapts
  //return '<script src = "/js/concat.js">'
